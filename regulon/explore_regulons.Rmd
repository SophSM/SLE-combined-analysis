...
up_genes_df <- data.frame(geneName = genes_up, regulon = regulon_column, direction = "Upregulated")
...
down_genes_df <- data.frame(geneName = genes_down, regulon = regulon_column, direction = "Downregulated")
