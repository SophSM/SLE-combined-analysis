...
df1.small$Var1 <- revalue(df1.small$Var1, c("protein_coding"="Protein coding", "protein_coding_CDS_not_defined"="Protein coding CDS not defined"))
...
df2.small$Var1 <- revalue(df2.small$Var1, c("protein_coding"="Protein coding", "protein_coding_CDS_not_defined"="Protein coding CDS not defined"))
...
p <- ggplot(data = df1.small, aes(x = Var1, y = Freq)) + 
  ...
  scale_y_continuous(limits = c(0,306), expand = c(0, 0)) + 
...
ggsave(paste0(outdir, "biotypes_up_barplot.png"), plot = p, dpi = 300)
