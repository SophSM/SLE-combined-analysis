...
row_ha <- rowAnnotation(logFC = l2_val, col = list(logFC =col_logFC))
h2 <-Heatmap(mat, cluster_rows = F, name = 'Norm counts', right_annotation = row_ha, top_annotation = ha, column_km = 2, border = T)
outdir = "/mnt/Citosina/amedina/ssalazar/meta/combined/"

png(paste0(outdir,'heatmapAll.png'), width = 5000, height  = 10000, res = 300)
  h2
dev.off()
